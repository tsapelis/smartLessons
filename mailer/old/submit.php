    ...
    <div class="clr"></div>
        	...
        	<div class="module-outline-2">
            	<div class="rt-block">
                        ...
                        <div class="rt-block">
                                <div class="module-content">
                	<p><span style="color: #3c9fa4;"><em><span style="text-align: right; font-family: arial, terminal, monaco; font-size: 11pt;">Ο
 αθλητικός ποδηλατικός σύλλογος ΠΡΩΤΕΑΣ είναι μη κερδοσκοπικού 
χαρακτήρα, ιδρύθηκε το 2001 από ανθρώπους που αγαπούν την ποδηλασία. 
Έχει στην δύναμη του σημαντικό αριθμό αξιόλογων αθλητών σε όλες τις 
κατηγορίες, οι οποίοι με την βοήθεια ικανότατων προπονητών βρίσκονται 
πάντα ανάμεσα σε πρωταγωνιστικές θέσεις.</span></em></span></p>            	</div>
            </div>
...
<div class="rt-joomla ">
	<div class="rt-blog">
		...
		<h3>Η αίτηση καταχωρήθηκε με επιτυχία !</h3>
		<p>&nbsp;</p>
		<p>
		  <a href="http://www.proteascycling.gr">Επιστροφή στην αρχική σελίδα</a>
		</p>
	</div>
